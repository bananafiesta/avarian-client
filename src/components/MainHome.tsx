    ...
    <div className="bg-[url('/rugged_highlands.jpg')] h-screen bg-cover">
      <Navbar>
        <Menu>
          ...
          <MenuItems transition anchor="bottom start" className="bg-black/50 text-white backdrop-blur-sm p-1 rounded-xl origin-center transition duration-100 ease-out data-[closed]:scale-95 data-[closed]:opacity-0 [--anchor-gap:8px] min-w-[var(--button-width)] font-lg">
            <MenuItem>
